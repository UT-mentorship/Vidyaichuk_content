...
const OperatingSystems = () => {
  ...
  const courseData = {
    ...
    approach: [
      ...
      "Implement socket programming and Inter-Process Communication (IPC) mechanisms in C to demonstrate communication between processes.",
    ...
    courseLinks: [
      {
        name: "Udacity: Intro to OS",
        url: "https://www.udacity.com/course/intro-to-operating-systems--ud923",
        icon: <Code className="mr-2 h-4 w-4" />,
      },
      {
        name: "Smurti R. Sarangi: OS",
        url: "https://www.cse.iitd.ac.in/~srsarangi/osbook/index.html",
        icon: <Book className="mr-2 h-4 w-4" />,
      },
      {
        name: "Zephyr: Tutorial for beginners",
        url: "https://github.com/maksimdrachov/zephyr-rtos-tutorial",
        icon: <Github className="mr-2 h-4 w-4" />,
      },
      {
        name: "NPTEL (OS)",
        url: "https://archive.nptel.ac.in/courses/106/102/106102132/",
        icon: <School className="mr-2 h-4 w-4" />,
      },
      {
        name: "NPTEL (RTOS)",
        url: "https://archive.nptel.ac.in/courses/106/105/106105172/",
        icon: <School className="mr-2 h-4 w-4" />,
      },
    ],
    videoReferences: [
      {
        title: "FreeCodeCamp: C Programming Tutorial for Beginners",
        url: "https://www.youtube.com/watch?v=KJgsSFOSQv0",
        platform: "YouTube"
      },
      {
        title: "NeuralNine: How To Set Up A Linux Virtual Machine",
        url: "https://www.youtube.com/watch?v=ilCB9T3D_2M",
        platform: "YouTube"
      },
      {
        title: "Nordic Semiconductor: Introduction to the Zephyr RTOS",
