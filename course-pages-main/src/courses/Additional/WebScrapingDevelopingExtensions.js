...
import { ExternalLink, Youtube, FileText, Code, Book, School, Network, Bot, Apple, AppleIcon, LucideApple, Target, Chrome } from "lucide-react";

const WebScrapingDevelopingExtensions = () => {
    ...
    const courseData = {
        title: "Web Scraping and Developing Extensions for Browsers",
        description: "Learn web scraping and browser extension development with this course. Use Python libraries like Beautiful Soup, Scrapy, and Selenium to extract data, including from dynamic pages. Build Chrome or Firefox extensions that integrate APIs for innovative solutions. Master session management, ethical scraping practices, and data handling while applying your skills in real-world projects.",
        outcomes: [
            "Master web scraping techniques using Python libraries (such as Beautiful Soup, Scrapy, and Selenium) for data and image extraction from websites, including dynamic and authenticated pages.",
            "Learn to develop browser extensions for Chrome or Firefox that enhance user experience or integrate with web services, utilising APIs like those from the India Stack for innovative solutions.",
            "Understand how to manage authentication, cookies, and session data in web scraping, and learn best practices for storing and using scraped data.",
            "Gain knowledge of the legal and ethical considerations in web scraping and browser extension development."
        ],
        approach: [
            "Use these Python libraries to scrape common websites and understand when to use which tool.",
            "Follow step-by-step guides available on MDN Web Docs (Mozilla Developer Network) or Chrome Developers site to create basic extensions.",
            "Engage in projects that require scraping data from publicly available websites, ensuring compliance with terms of service. Use this data in conjunction with APIs like those from India Stack to create meaningful applications and extensions."
        ],
        courseLinks: [
            {
                name: "Udemy: Web Scraping in Python Selenium, Scrapy + ChatGPT",
                url: "https://www.udemy.com/course/web-scraping-course-in-python-bs4-selenium-and-scrapy/?couponCode=LEARNNOWPLANS",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "CodeAcademy: Learn Web Scraping with Beautiful Soup",
                url: "hhttps://www.codecademy.com/learn/learn-web-scraping",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "Chrome: Publishing to Chrome Web Store Tutorials",
                url: "https://developer.chrome.com/docs/extensions/get-started#tutorials",
                icon: <Chrome className="mr-2 h-6 w-6" />,
            },
        ],
        videoReferences: [
            {
                title: "John Watson Rooney: Modern Web Scraping with Python",
                url: "https://www.youtube.com/playlist?list=PLRzwgpycm-Fio7EyivRKOBN4D3tfQ_rpu",
                platform: "YouTube"
            },
            {
                title: "JavaScript Mastery: Web Scraping Full Course 2024 | Build and Deploy eCommerce Price Tracker",
                url: "https://www.youtube.com/watch?v=lh9XVGv6BHs",
                platform: "YouTube"
            },
            {
                title: "Atharv varshney: Chrome Extension development",
                url: "https://www.youtube.com/playlist?list=PLXT4oy8Eb6MoOmOEcFyvbbJ-DHeduDdwl",
                platform: "YouTube"
            },
        ],
...
export default WebScrapingDevelopingExtensions;
