...
import { ExternalLink, Youtube, FileText, Code, Book, School, Network, Bot, Apple, AppleIcon, LucideApple } from "lucide-react";
...
const InternetOfThings = () => {
    ...
    const courseData = {
        ...
        description: "Explore the world of IoT with this course, covering its architecture, applications, and essential components. Master protocols like MQTT and CoAP while integrating IoT devices with cloud platforms like AWS IoT, Google Cloud, and Azure IoT Hub. Learn to secure IoT systems and apply your skills through hands-on projects and virtual simulations using tools like Tinkercad and HiveMQ.",
        outcomes: [
            "Understand the basics of IoT, including its applications across various industries, the architecture of IoT systems, and key components that make up IoT devices and networks.",
            "Master the communication protocols specific to IoT, such as MQTT, CoAP, and HTTP, understanding their use cases.",
            "Learn to integrate IoT devices with cloud platforms (AWS IoT, Google Cloud IoT, Azure IoT Hub) for data storage, processing, and analysis, applying cloud-based machine learning for IoT data.",
            "Understand the security vulnerabilities associated with IoT devices and networks, and learn best practices for securing IoT systems."
        ],
        approach: [
            "Use basic IoT boards or components to get started and develop basic applications through them.",
            "Tools like Tinkercad can be used to handle IoT simulations and work on things virtually.",
            "Utilise platforms like HiveMQ’s public MQTT broker to simulate IoT device communications and understand protocol behaviour in real-world scenarios.",
            "Apply theoretical knowledge by integrating virtual IoT devices with cloud services such as AWS IoT Core, Google Cloud IoT Core, or Microsoft Azure IoT Hub.",
            "Build interesting projects taking inspiration from sites like https://www.hackster.io/."
        ],
        courseLinks: [
            {
                name: "Udemy: Complete Guide to Build IOT Things from Scratch to Market",
                url: "https://www.udemy.com/course/complete-guide-to-build-iot-things-from-scratch-to-market/?couponCode=LEARNNOWPLANS",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "Coursera: Hands-on Internet of Things Specialization",
                url: "https://www.coursera.org/specializations/uiuc-iot",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "Coursera: Internet of Things and AI Cloud Specialization",
                url: "https://www.coursera.org/specializations/internet-of-things",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "Coursera: Programming with Cloud IoT Platforms",
                url: "https://www.coursera.org/learn/cloud-iot-platform/",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
            ...
            {
                name: "NPTEL: Foundation of Cloud IoT Edge ML",
                url: "https://archive.nptel.ac.in/courses/106/104/106104242//",
                icon: <School className="mr-2 h-6 w-6" />,
            },
        ],
        // videoReferences: [
        //     { title: "FreeCodeCamp: Kotlin & Android Development Course: Build a Quiz Application",
        //       url: "https://www.youtube.com/watch?v=kNghEbknLs8", 
        //       platform: "YouTube" 
        //     },
        // ],
