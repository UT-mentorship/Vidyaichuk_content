...
const AdvancedDatabases = () => {
    ...
    const courseData = {
        ...
        description: "Explore advanced database systems with this course, focusing on time-series databases like InfluxDB and columnar databases like Druid. Learn their unique use cases, efficient data storage, and querying techniques. Practice data ingestion, schema optimisation, and performance tuning. Apply your skills through real-world projects like IoT data analysis or event logging to harness the full potential of specialised databases.",
        outcomes: [
        ...
        courseLinks: [
            {
                name: "Time Series DB - influx | Influx University",
                url: "https://university.influxdata.com/",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "Time Series DB - influx | Influx Data",
                url: "https://www.influxdata.com/university/",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "Udemy: Apache Druid - A Hands-on Course (Paid)",
                url: "https://www.udemy.com/course/apache-druid-a-hands-on-course/",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "Imply: Apache Druid Training",
...
export default AdvancedDatabases;
