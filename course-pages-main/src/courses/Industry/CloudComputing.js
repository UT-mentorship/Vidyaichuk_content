...
const CloudComputing = () => {
    ...
    const courseData = {
        ...
        description: "Unlock the power of the cloud with this practical course! Discover the core concepts of cloud computing, from virtualisation to service models (IaaS, PaaS, SaaS). Learn to deploy, scale, and secure web applications on platforms like AWS, GCP, and Azure. Gain hands-on experience with VMs, containers, cloud databases, and CI/CD pipelines.",
        outcomes: [
            "Learn the features and services offered by major cloud platforms like Azure/GCP/AWS, focusing on virtual machines, containerisation, cloud databases, scaling, load balancing, and security practices.",
            "Grasp fundamental cloud computing concepts, including virtualisation, cloud storage, and cloud service models (IaaS, PaaS, SaaS).",
            "Understand cloud security measures, identity access management (IAM), and best practices for managing and monitoring cloud resources.",
        ...
        approach: [
            "Explore GCP, AWS, Azure and their features, advantages, and limitations through the credits students get through their institutional mail.",
            "Set up virtual machines (VMs) and work with container services like Azure Container Instances, Amazon ECS, or Google Kubernetes Engine (GKE), understanding the deployment and scaling of containerised applications.",
            "Utilise cloud database services, such as Azure SQL Database, Amazon RDS, or Google Cloud SQL, and integrate them with their pre-built applications.",
            "Build and deploy a full-stack application on their chosen cloud platform, implementing CI/CD pipelines for automated testing and deployment.",
            "Make use of services and tools available with cloud efficiently to improve projects."
        ],
        courseLinks: [
            {
                name: "Coursera: Intro to Cloud Computing",
                url: "https://www.coursera.org/learn/introduction-to-cloud",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "Coursera: AWS Fundamentals Sepcialization",
                url: "https://www.coursera.org/specializations/aws-fundamentals",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "Coursera: Google Cloud Fundamentals",
                url: "https://www.coursera.org/learn/gcp-fundamentals",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "Coursera: Intro to MS Azure Cloud Services",
                url: "https://www.coursera.org/learn/microsoft-azure-cloud-services",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "NPTEL: Google Cloud Computing Foundation",
                url: "https://archive.nptel.ac.in/courses/106/105/106105223/",
                icon: <School className="mr-2 h-4 w-4" />,
            }
        ],
        videoReferences: [
            {
                title: "Scaler: AWS Complete Tutorial 2023 | Learn Amazon Web Services from Scratch | Cloud Computing | @SCALER",
