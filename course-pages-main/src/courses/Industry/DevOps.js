...
const DevOps = () => {
    ...
    const courseData = {
        title: "DevOps",
        description: "Dive into DevOps with this hands-on course! Master Linux commands, bash scripting, and package management as a foundation. Gain proficiency in version control, build tools like Maven, and source code management using Ansible. Learn CI/CD concepts with Jenkins, integrate AWS tools, and explore Docker and Kubernetes for modern, scalable solutions.",
        outcomes: [
            "Be proficient with commands, bash scripting, and process and package management in Linux as prerequisites.",
            "Get familiar with VCS concepts and usage like git, GitHub, GitLab, etc.",
            "Understand the usage and importance of build tools and get proficient with Maven along with its commands.",
            "Understand SCM (Source Code Management) and proficiently use Ansible and its associated features.",
            "Understand CI/CD and get familiar with Jenkins, its security, authentication, authorization, libraries, backup, and its uses.",
            "Revise AWS fundamentals and tools learnt in the cloud computing course and integrate them with DevOps concepts.",
            "Get familiar with the usage and fundamentals of Docker and Kubernetes."
        ],
        approach: [
            "Revise Linux, bash concepts from previous courses, and do practical exercises to become proficient.",
            "Revise VCS concepts learnt earlier.",
            "Use Maven as a build tool and try it for various projects previously built by doing hands-on.",
            "Use Ansible for the projects completed till now or take up new projects.",
            "Do projects requiring CI/CD along with Jenkins in teams or contribute to open source projects that use these concepts.",
            "Make a project based on AWS, and finally, use Docker, Kubernetes, and DevOps concepts to gain practical exposure to all the concepts learned."
        ],
        courseLinks: [
            {
                name: "Coursera: CI/CD | IBM",
                url: "https://www.coursera.org/learn/continuous-integration-and-continuous-delivery-ci-cd",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "MyGurukulam: DevOps Ninja Program",
                url: "https://www.mygurukulam.co/devops/",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "Udemy: Maven Quick Start",
        ...
        videoReferences: [
            {
                title: "Simplilearn: Ansible Full Course 2024",
                url: "https://www.youtube.com/watch?v=BS0GLQaSGPo",
                platform: "YouTube"
            },
            {
                title: "Simplilearn: Jenkins Full Course",
                url: "https://www.youtube.com/watch?v=FX322RVNGj4",
                platform: "YouTube"
            },
            {
                title: "FreeCodeCamp: Docker Containers and Kubernetes Fundamentals – Full Hands-On Course",
