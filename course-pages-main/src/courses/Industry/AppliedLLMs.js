...
import { ExternalLink, Youtube, FileText, Code, Book, School, Network, Bot, Apple, AppleIcon, LucideApple, Target } from "lucide-react";
...
const AppliedLLMs = () => {
    ...
    const courseData = {
        title: "Applied LLMs",
        description: "Gain a solid foundation in large language models (LLMs) with this course, covering their principles, training processes, and applications. Learn to integrate APIs from models like ChatGPT into custom projects and explore tools like LangChain for content creation and data analysis. Apply generative AI in real-world applications and understand the deployment of LLMs at scale using resources like LLMops.",
        outcomes: [
            "Understand the basic principles behind large language models, including how they are trained, their capabilities, and their limitations.",
            "Gain practical experience in leveraging APIs from models like ChatGPT for application development, as well as the know-how to train and deploy custom GPT models for specific tasks.",
            "Apply generative AI tools and platforms, such as LangChain, to create novel applications that harness the power of LLMs for content creation, data analysis, and more."
        ],
        approach: [
            "Enroll in specific courses on deep learning and LLMs offered by platforms like DeepLearning.AI. Focus on modules that cover the fundamentals of neural networks, sequence models, and the architecture of models like GPT.",
            "Use documentation and tutorials to integrate ChatGPT and other LLM APIs into custom projects. Platforms like OpenAI provide extensive guides for developers to embed LLM functionalities into applications.",
            "Experiment with building applications using LangChain and other generative AI tools.",
            "Explore resources on LLMops to understand the intricacies of deploying LLMs at scale practically."
        ],
        courseLinks: [
            {
                name: "Deeplearning.ai: Fundamentals of generative AI",
