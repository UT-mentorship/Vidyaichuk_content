...
const BasicWebDevelopment = () => {
    ...
    const courseData = {
        ...
        outcomes: [
            ...
            "Get familiar with concepts of backend development through Django, learning about models, views, templates, and how to handle web requests and responses."
        ],
        approach: [
        ...
        courseLinks: [
            {
                name: "Coursera: HTML, CSS & JS for Web Developers",
                url: "https://www.coursera.org/learn/html-css-javascript-for-web-developers",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "Coursera: Django Web Framework | Meta",
                url: "https://www.coursera.org/learn/django-web-framework",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "NPTEL: Intro to Modern App Development",
                url: "https://archive.nptel.ac.in/courses/106/106/106106156/",
                icon: <School className="mr-2 h-4 w-4" />,
            },
        ],
        videoReferences: [
            {
                title: "FreeCodeCamp: Frontend Web Development Bootcamp Course (JavaScript, HTML, CSS)",
                url: "https://www.youtube.com/watch?v=zJSY8tbf_ys",
                platform: "YouTube"
            },
            {
                title: "FreeCodeCamp: Django For Everybody - Full Python University Course",
...
export default BasicWebDevelopment;
