...
const DataEngineering = () => {
    ...
    const courseData = {
        ...
        courseLinks: [
            {
                name: "Coursera: IBM Data Engineering",
                url: "https://www.coursera.org/professional-certificates/ibm-data-engineer",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "NPTEL: Big Data Computing",
                url: "https://archive.nptel.ac.in/courses/106/104/106104189/",
                icon: <School className="mr-2 h-6 w-6" />,
            },
        ],
        videoReferences: [
            {
                title: "Multiple Youtubers: Data Engineering Playlist",
                url: "https://www.youtube.com/playlist?list=PLKJR9faABQiRkFSzD4Wr8oL9lI9frjEOv",
                platform: "YouTube"
            },
        ],
