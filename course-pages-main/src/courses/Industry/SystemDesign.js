...
const SystemDesign = () => {
    ...
    const courseData = {
        title: "System Design",
        description: "Understand the core principles of system design with this course. Learn Low-Level Design (LLD) and High-Level Design (HLD), covering system architecture, data storage, and component integration. Focus on scalability, fault tolerance, and security, while applying concurrency models and multithreading. Analyze real-world case studies, use design tools like Lucidchart, and tackle standard design problems to refine your skills.",
        outcomes: [
        ...
        courseLinks: [
            {
                name: "Coursera: Software Design and Architecture Specialization",
                url: "https://www.coursera.org/specializations/software-design-architecture",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "NPTEL: Design and Engineering of Computer Systems",
                url: "https://archive.nptel.ac.in/courses/106/101/106101234/",
