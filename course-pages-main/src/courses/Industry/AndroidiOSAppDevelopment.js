...
const AndroidiOSAppDevelopment = () => {
    ...
    courseLinks: [
      {
        ...
        icon: <Bot className="mr-2 h-6 w-6" />,
      },
      {
        name: "Apple: Developing Back-End Apps with Node.js and Express",
        url: "https://developer.apple.com/tutorials/app-dev-training/",
        icon: <Apple className="mr-2 h-6 w-6" />,
      },
      {
        name: "Coursera: Meta iOS Developer Professional Certificate",
        url: "https://www.coursera.org/professional-certificates/meta-ios-developer",
        icon: <Code className="mr-2 h-6 w-6" />,
      },
      {
        name: "NPTEL: Mobile Computing",
        url: "https://archive.nptel.ac.in/courses/106/106/106106147/",
...
export default AndroidiOSAppDevelopment;
