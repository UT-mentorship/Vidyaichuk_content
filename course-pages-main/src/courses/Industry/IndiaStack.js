...
const IndiaStack = () => {
    ...
    const courseData = {
        title: "India Stack",
        description: "Explore the potential of India Stack APIs in this practical course. Learn to integrate APIs like UPI, Aadhaar, eKYC, and Ayushman Bharat to solve real-world problems in digital payments, identity verification, and healthcare. Gain hands-on experience with tools like Postman, and participate in hackathons to build innovative projects. Use cloud platforms to deploy your applications, applying your prior knowledge in fintech and healthcare sectors.",
        outcomes: [
            "Understand the functionalities and use cases of India Stack APIs including UPI, Beckn, OCEN, FastTag, Aadhaar, eKYC, eSign, ONDC, BBPS, and Ayushman Bharat Digital Mission.",
            "Gain hands-on experience in integrating these APIs into applications, focusing on solving real-world problems like digital payments, identity verification, and healthcare data management.",
            "Encourage active participation in hackathons and challenges that focus on utilizing India Stack APIs, fostering innovation and problem-solving skills.",
            "Learn to build and deploy projects that leverage India Stack APIs, demonstrating the potential for innovation in fintech, healthcare, and other sectors using the knowledge of the courses already learned before this."
        ],
        approach: [
            "Get used to API documentation of different technologies as you use them.",
            "Use tools like Postman to test India Stack APIs before adding them to your projects.",
            "Encourage building simple applications that use these APIs, such as a UPI-based payment system, an eKYC verification tool, or a healthcare data management system using Ayushman Bharat Digital Mission APIs.",
            "Leverage cloud platforms like AWS, Google Cloud, or Azure to deploy applications developed using India Stack APIs."
        ],
        courseLinks: [
            {
                name: "IndiaStack.org",
                url: "https://indiastack.org/index.html",
                icon: <Book className="mr-2 h-4 w-4" />,
            },
            {
                name: "ONDC: Tech Resources",
                url: "https://resources.ondc.org/tech-resources",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
            {
                name: "UIDAI: Developer Section",
                url: "https://www.uidai.gov.in/en/914-developer-section.html",
                icon: <Code className="mr-2 h-4 w-4" />,
            },
        ],
        apiReferences: [
            {
                name: "UIDAI: Aadhaar Authentication API 1.6",
                url: "https://uidai.gov.in/images/resource/Aadhaar_Authentication_API-2.5_Revision-1_of_January_2022.pdf",
                icon: <FileText className="mr-2 h-4 w-4" />,
            },
            {
                name: "CCA: eSign API Specifications",
                url: "https://cca.gov.in/eSignAPI.html",
                icon: <FileText className="mr-2 h-4 w-4" />,
            },
            {
                name: "HDFC: Fastag Integration",
                url: "https://www.uidai.gov.in/en/914-developer-section.html",
                icon: <FileText className="mr-2 h-4 w-4" />,
            },
            {
                name: "Ayushman Bharat Digital Mission: UHI Application APIs",
                url: "https://sandbox.abdm.gov.in/docs/getting_started_with_apis",
                icon: <FileText className="mr-2 h-4 w-4" />,
            },
        ],
        // videoReferences: [
        ...
        //       platform: "YouTube" 
        //     },
        //     { title: "SCALER: System Design Roadmap",
        //       url: "https://www.youtube.com/playlist?list=PLLhBy6YSIT0ANaihpjwDBSBju0qUZ82SK", 
        //       platform: "YouTube" 
        //     },
        // ],
    ...
    const renderResources = () => (
        <div className="space-y-6">
            ...
            <div className="bg-white shadow rounded-lg p-6">
                <h2 className="text-2xl font-bold text-[#2596be] mb-4 flex items-center">
                    <FileText className="mr-2 h-6 w-6" /> API References
                </h2>
                <h3 className="text-l mb-4">
                    Official api documentation is provided below, of the majority of India stack platforms. The knowledge gained in cloud computing, advanced web development and distributed systems can be used to build applications on top of this:
                </h3>
                <div className="grid md:grid-cols-3 gap-4">
                    {courseData.apiReferences.map((link, index) => (
                        <a
                            key={index}
                            href={link.url}
                            target="_blank"
