...
const ModernProgrammingToolsAndAutomation = () => {
  ...
  const courseData = {
    title: "Modern Programming Tools and Automation",
    description: "Master modern programming tools and automation techniques with this hands-on course! Explore shell commands for data handling and networking, manage projects using GitHub, and set up systems with low-code platforms like Zapier and Webflow. Harness AI-driven tools like GitHub Copilot for programming and API design, building skills for real-world efficiency.",
    outcomes: [
    ...
    courseLinks: [
      {
        name: "Coursera: Intro to Linux Commands and Shell Scripting",
        url: "https://www.coursera.org/learn/hands-on-introduction-to-linux-commands-and-shell-scripting",
        icon: <Code className="mr-2 h-4 w-4" />,
      },
      {
        name: "Coursera: Getting Started with Git and GitHub",
        url: "https://www.coursera.org/learn/getting-started-with-git-and-github",
        icon: <Code className="mr-2 h-4 w-4" />,
      },
      {
        name: "Webflow: Webflow Tutorial",
        url: "https://webflow.com/blog/webflow-tutorial",
        icon: <Book className="mr-2 h-4 w-4" />,
      },
      {
        name: "VS Code: Getting started w/ Github Copilot",
        url: "https://code.visualstudio.com/docs/copilot/getting-started",
        icon: <Github className="mr-2 h-4 w-4" />,
      },
      {
        name: "NPTEL: Linud Proggraming & Scripting",
    ...
    videoReferences: [
      {
        title: "FreeCodeCamp: The 50 Most Popular Linux & Terminal Commands - Full Course for Beginners",
        url: "https://www.youtube.com/watch?v=ZtqBQ68cfJc",
        platform: "YouTube"
      },
      {
        title: "linuxhint: Bash Scripting Full Course 3 Hours",
        url: "https://www.youtube.com/watch?v=e7BufAVwDiM",
        platform: "YouTube"
      },
      {
        title: "FreeCodeCamp: Git and Github Freecodecamp",
        url: "https://www.youtube.com/playlist?list=PLLJ1hZKyeCH1I8dP0UNTpWoIhsl6KpVbu",
        platform: "YouTube"
      },
      {
        title: "Metics Media: The Only Webflow Tutorial You Will Ever Need (FOR BEGINNERS)",
        url: "https://www.youtube.com/watch?v=cZlnnbHNKrE",
        platform: "YouTube"
      },
      {
        title: "Masters of AI & Automation: Zapier 101",
        url: "https://www.youtube.com/playlist?list=PLcFpLbKfavFwFmQj8rPlVFFRrcKApYl7X",
        platform: "YouTube"
      },
      {
        title: "Github: Coding with an AI pair programmer: Getting started with GitHub Copilot",
        url: "https://www.youtube.com/watch?v=dhfTaSGYQ4o",
        platform: "YouTube"
      },
      {
        title: "FreeCodeCamp: Easily Automate Business Tasks – No-Code Automation Course",
...
export default ModernProgrammingToolsAndAutomation;
