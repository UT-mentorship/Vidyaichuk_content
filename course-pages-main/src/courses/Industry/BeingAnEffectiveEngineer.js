...
const BeingAnEffectiveEngineer = () => {
    ...
    const courseData = {
        ...
        description: "Enhance your engineering career with this course, focusing on personal and project management techniques to boost productivity and problem-solving skills. Improve communication for clear documentation and presentations, and adopt best coding practices. Learn about SDLC models like Agile, explore continuous learning strategies, and understand ethical considerations in software development. Apply these skills in real-world projects and open-source contributions for career growth.",
        outcomes: [
            "Master personal and project management techniques to enhance productivity, along with developing robust problem-solving skills for tackling complex engineering challenges.",
            "Improve communication skills for clearer project documentation and presentations, foster effective team collaboration, and adopt best coding practices to ensure code quality and maintainability.",
            "Gain a comprehensive understanding of the software development lifecycle (SDLC) models, such as Agile and Scrum, and explore strategies for continuous learning and career advancement in the tech industry.",
            "Understand the ethical considerations in software development, focusing on data privacy, security, and the social impact of technology."
        ],
        approach: [
            "Read the book or at least the important broad topics which the book covers.",
            "Read multiple articles and consult multiple resources on the book's topics.",
            "Use practices laid out in your projects and for teamwork.",
            "Participate in open-source projects to utilize the lessons. Participate in some mentorship programs for open-source projects that help you apply these principles.",
            "Use these aspects for a good career with growth."
        ],
        courseLinks: [
            {
                name: "Book: The Effective Engineer",
                url: "https://www.effectiveengineer.com/book",
                icon: <Book className="mr-2 h-6 w-6" />,
            },
            {
                name: "Coursera: Software Development Lifecycle Specialization",
                url: "https://www.coursera.org/specializations/software-development-lifecycle",
                icon: <Code className="mr-2 h-6 w-6" />,
            },
            {
                name: "MIT OCW: Ethics of Technology",
                url: "https://ocw.mit.edu/courses/24-131-ethics-of-technology-spring-2023/",
                icon: <School className="mr-2 h-6 w-6" />,
            },
            {
                name: "NPTEL: Software Engineering | IIT KGP",
                url: "https://archive.nptel.ac.in/courses/106/105/106105182/",
                icon: <School className="mr-2 h-6 w-6" />,
            },
            {
                name: "NPTEL: Software Engineering | IIT B",
                url: "https://archive.nptel.ac.in/courses/106/101/106101061/",
                icon: <School className="mr-2 h-6 w-6" />,
            },
        ],
        // videoReferences: [
...
export default BeingAnEffectiveEngineer;
