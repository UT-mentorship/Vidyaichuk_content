...
const FoundationsOfComputerSecurity = () => {
    ...
    const courseData = {
        ...
        courseLinks: [
            {
                name: "Coursera: Intro to Cybersecurity Tools & Cyberattacks",
            ...
            {
                name: "NPTEL: Intro to Information Security I",
                url: "https://archive.nptel.ac.in/courses/106/106/106106129/",
                icon: <School className="mr-2 h-4 w-4" />,
            },
        ],
        videoReferences: [
            {
                title: "Simplilearn: Cryptography Playlist [2024 Updated] 🔥",
                url: "https://www.youtube.com/playlist?list=PLEiEAq2VkUULgKbiq9J4z517w8RV3-yJe",
                platform: "YouTube"
            },
        ],
...
export default FoundationsOfComputerSecurity;
